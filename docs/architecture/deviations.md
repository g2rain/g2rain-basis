...
- 已补文档：当前调用方向、代表契约与目标控制见[受信服务 API 与跨服务协作](../design/trusted-service-collaboration.md)。
...
- 已补文档：跨服务步骤、本地事务边界、部分成功事实和目标恢复策略见[受信服务 API 与跨服务协作](../design/trusted-service-collaboration.md)。
