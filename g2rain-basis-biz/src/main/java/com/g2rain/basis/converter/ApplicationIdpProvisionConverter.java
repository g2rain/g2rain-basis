...
public interface ApplicationIdpProvisionConverter {

    /**
     * 单例实例，通过 {@link Mappers#getMapper(Class)} 获取 MapStruct 自动生成的实现。
     */
    ApplicationIdpProvisionConverter INSTANCE = Mappers.getMapper(ApplicationIdpProvisionConverter.class);
    ...
    ApplicationIdpProvisionVo po2vo(ApplicationIdpProvisionPo po);
    ...
    ApplicationIdpProvisionPo dto2po(ApplicationIdpProvisionDto dto);
}
