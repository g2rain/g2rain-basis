...
VALUES
    (7, 2, '综合管理平台', 'g2rain-main-shell',  0, 1, 0, 'SUPPORT', 'EC', 'PEM', '-----BEGIN PUBLIC KEY----- MFkwEwYHKoZIzj0CAQYIKoZIzj0DAQcDQgAEXmlg1y2fUD9KJj4WB6DrRZU+iVwA yzz60AxRoFb2yDnBvYiiK9JR1p5QUw2jkR9RPvkZez1Kx2BqxwyOoWRV/A== -----END PUBLIC KEY----- ', 3600, 86400, '//demo.g2rain.com', '/main/',    'PUBLISHED', '管理平台入口', '2026-02-01 09:12:28', '2026-02-01 09:12:28'),
    (8, 2, '基础支撑平台', 'g2rain-infra-app',  1, 1, 0, 'SUPPORT', 'EC', 'PEM', '-----BEGIN PUBLIC KEY----- MFkwEwYHKoZIzj0CAQYIKoZIzj0DAQcDQgAEAcmLmXDroj3aJiTFxP6oy5Q+3Tawz1LFg0BY1a5CRNynqpVvG+/wVGUhXf7KOJ7/nA2OO/H+IQaHryS+SXtnOA== -----END PUBLIC KEY----- ', 3600, 86400, '//demo.g2rain.com', '/infra/',    'PUBLISHED', '字典、国际化与全局序列等公共能力前台', '2026-02-01 09:12:28', '2026-02-01 09:12:28'),
    (9, 2, '业务支撑平台', 'g2rain-manager-app',  1, 1, 0, 'SUPPORT', 'EC', 'PEM', '-----BEGIN PUBLIC KEY----- MFkwEwYHKoZIzj0CAQYIKoZIzj0DAQcDQgAEXGDOn5B+GFE42lcMd5u47r6na9iE H1AzxAU49KiWBz17su0M1vPZ+s57bvMlYvbcPG2nfWcJvJzRuKUakrUhsA== -----END PUBLIC KEY----- ', 3600, 86400, '//demo.g2rain.com', '/manager/',    'PUBLISHED', '平台运营与租户自助管理前台', '2026-02-01 09:12:28', '2026-02-01 09:12:28'),
    (10, 2, '部门管理平台', 'g2rain-department-app', 1, 0, 0, 'SUPPORT', 'EC', 'PEM', '-----BEGIN PUBLIC KEY----- MFkwEwYHKoZIzj0CAQYIKoZIzj0DAQcDQgAEtghefsDYicSn9s7OsNlwIoIlVTYZ DN9bBwnvKQUENpPuCXZj+qBb+kQBh5C5inokwbjzjbxP2vP360mhfovhag== -----END PUBLIC KEY----- ', 3600, 86400, '//demo.g2rain.com', '/department/', 'PUBLISHED', '部门组织与权限模型管理前台', '2026-02-01 09:12:28', '2026-02-01 09:12:28');
...
VALUES
    ...
    (152, 'G2RAIN_BASIS', '个人静态访问令牌', '修改个人静态访问令牌记录状态', 'POST', '/personal_static_access_token/{id}/status', '运营公司可跨租户修改；本机构调用方仅可修改本机构令牌', '2026-05-20 01:31:01', '2026-05-20 01:31:01'),
    ...
    (222, 'G2RAIN_BASIS', '个人静态访问令牌', '查询全部个人静态访问令牌列表', 'GET', '/personal_static_access_token/list_all', '按条件查询本租户全部个人静态访问令牌，不强制当前用户', '2026-09-17 00:00:00', '2026-09-17 00:00:00'),
    (223, 'G2RAIN_BASIS', '个人静态访问令牌', '分页查询全部个人静态访问令牌列表', 'GET', '/personal_static_access_token/page_all', '分页查询本租户全部个人静态访问令牌，不强制当前用户', '2026-09-17 00:00:00', '2026-09-17 00:00:00'),
    (224, 'G2RAIN_BASIS', '个人静态访问令牌', '为指定用户新增或更新个人静态访问令牌', 'POST', '/personal_static_access_token/save_for_user', '管理员为指定用户创建或更新个人静态访问令牌', '2026-09-17 00:00:00', '2026-09-17 00:00:00');
...
VALUES
    ...
    (849, 16, 222, 'API_ENDPOINT', NULL, '2026-09-17 00:00:00', '2026-09-17 00:00:00'),
    (850, 16, 223, 'API_ENDPOINT', NULL, '2026-09-17 00:00:00', '2026-09-17 00:00:00'),
    (851, 16, 224, 'API_ENDPOINT', NULL, '2026-09-17 00:00:00', '2026-09-17 00:00:00'),
    ...
    (852, 18, 222, 'API_ENDPOINT', NULL, '2026-09-17 00:00:00', '2026-09-17 00:00:00'),
    (853, 18, 223, 'API_ENDPOINT', NULL, '2026-09-17 00:00:00', '2026-09-17 00:00:00'),
    (854, 18, 224, 'API_ENDPOINT', NULL, '2026-09-17 00:00:00', '2026-09-17 00:00:00'),
    (855, 18, 152, 'API_ENDPOINT', NULL, '2026-09-18 00:00:00', '2026-09-18 00:00:00'),
    (856, 18, 328, 'PAGE_ELEMENT', 'ENABLED', '2026-09-18 00:00:00', '2026-09-18 00:00:00'),
