...
VALUES
    ...
    (384, 'G2RAIN_BASIS', '账号与外部身份源绑定', '已登录用户绑定外部身份源', 'POST', '/passport_idp_binding/bind', '已登录通行证扫码绑定钉钉（幂等）', '2026-05-20 09:31:01', '2026-05-20 09:31:01'),
...
VALUES
    ...
    (564,215,'organ','邀请码','organ:invite_generate','2026-05-28 00:00:00','2026-05-28 00:00:00'),
